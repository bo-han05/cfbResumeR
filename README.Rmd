...
The goal of cfbResumeR is to create a playoff picture from CFB team resumes based on-field dominance and record success, with configurable team counts and resume score weights.

## Installation

You can install the development version of cfbResumeR from [GitHub](https://github.com/) with:
